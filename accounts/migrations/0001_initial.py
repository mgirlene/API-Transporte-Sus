...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='EnderecoUser',
            fields=[
                ('id', models.AutoField(db_column='id_enderecouser', primary_key=True, serialize=False)),
                ('localizacao', models.CharField(max_length=255)),
                ('cidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ubs.cidade')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ubs.estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endereco', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.enderecouser')),
